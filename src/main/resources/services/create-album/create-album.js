...
exports.post = function (req) {
    ...
    var albumId = portalLib.getMultipartText('albumId');

    if (!!albumId) {
        album = imageXpertLib.getAlbum(albumId);
        log.info('Adding to existing album ' + albumId);
    }
    else if (!!portalLib.getMultipartText('albumName')) {
    ...
    if (!!albumId) {
        images = createImages(albumId, publish);
        log.info('Added ' + images.length + ' images');
    }
    else {
